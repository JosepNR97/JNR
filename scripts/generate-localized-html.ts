    ...
    [
      ...SUPPORTED_LANGUAGES.map(
        (
          ...
          `    <link rel="alternate" hreflang="${language}" href="${getLocalizedUrl(
            language,
          )}" />`,
      ),
      `    <link rel="alternate" hreflang="x-default" href="${getLocalizedUrl(
        'es',
      )}" />`,
    ].join('\n');

const renderOpenGraphAlternates =
  (
    language: Language,
  ) =>
    getSeoLocaleData(
    ...
    [
      ...SUPPORTED_LANGUAGES.map(
        (
          ...
          `    <xhtml:link rel="alternate" hreflang="${language}" href="${getLocalizedUrl(
            language,
          )}" />`,
      ),
      `    <xhtml:link rel="alternate" hreflang="x-default" href="${getLocalizedUrl(
        'es',
      )}" />`,
    ].join('\n');
...
export const generateLocalizedPages =
  (
    projectRoot: string,
  ): void => {
    for (
